...
export default function ContactPage() {
  ...
  const updateField =
    ...
    (
      ...
      const value =
        field === "message"
          ? event.target.value.slice(0, MESSAGE_MAX)
          : event.target.value;
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!name || !email || !phone || message.length < 10) {
      toast.error(
        "Please add your name, email, phone, and a message (10+ characters).",
      );
      return;
    }
    ...
    try {
      ...
      const response = await fetch("/api/consultation", {
        ...
        body: JSON.stringify({ name, email, phone, message: composedMessage }),
    ...
    <>
      <main className="min-h-screen bg-[#030d18] text-white overflow-hidden">
        ...
        <section className="relative pt-28 md:pt-36 lg:pt-40 pb-16 md:pb-20 lg:pb-24">
          ...
          <div className="container mx-auto max-w-7xl px-5 relative z-10">
            ...
            <h1 className="mt-6 font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-tight max-w-4xl">
              Let&apos;s Build Your
              <span className="block text-cyan-400">Dream Aquarium</span>
            </h1>

            <p className="mt-8 max-w-2xl text-slate-300 text-base md:text-lg leading-8">
              Whether you&apos;re planning a luxury aquarium, custom aquascape,
              planted tank or commercial installation, our aquarium experts are
            ...
            <div className="mt-7 flex flex-wrap gap-4">
              ...
              <Link href="/consultation" className="btn-secondary px-6 py-3">
                Book Consultation
              </Link>
            </div>
          </div>
            ...
            <div className="pt-6">
              <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
                ...
                >
                  ...
                  <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-cyan-500/20 transition-all duration-500 group-hover:rotate-12 group-hover:scale-110 group-hover:bg-cyan-500">
                  ...
                  <p className="relative mt-3 text-slate-400">+91 9359707404</p>
                ...
                >
                  ...
                  <h3 className="mt-6 text-xl font-semibold">Working Hours</h3>
            ...
            <div className="rounded-[34px] border border-white/10 bg-white/5 backdrop-blur-xl p-6 md:p-10 lg:p-14">
              ...
              <div className="mb-12">
                ...
                <p className="mt-4 max-w-2xl leading-7 text-slate-400">
                  Fill in the details below and our aquarium specialists will
                  contact you shortly.
                </p>
              </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex w-full items-center justify-center rounded-2xl bg-cyan-500 px-10 py-4 font-semibold text-black transition-all duration-300 hover:scale-[1.02] hover:bg-cyan-400 disabled:cursor-not-allowed disabled:opacity-60 md:w-auto"
                  >
          ...
          <div className="container mx-auto max-w-7xl px-5">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-400">
                Visit our aquarium studio and explore beautiful custom
                aquariums, premium aquascapes and underwater ecosystems.
              </p>
            </div>

            <div className="overflow-hidden rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,255,255,0.08)]">
              {/* Google Map */}

              <div className="overflow-hidden">
                <iframe
                  title="Aquarium Nature Studio location map"
                  ...
                  className="h-[300px] md:h-[420px] lg:h-[520px] w-full border-0"
                />
              </div>
          ...
          <div className="container mx-auto max-w-7xl px-5">
            <div className="text-center mb-12">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-slate-400 leading-7">
                Visit our studio during working hours or contact us anytime
                online.
              </p>
            </div>
          ...
          <div className="container mx-auto max-w-7xl px-5">
            ...
            <div className="text-center mb-12">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-slate-400 leading-7">
                ...
                aquascaping inspiration, maintenance tips, and exclusive
                updates.
              </p>
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
              ...
              >
                <div className="absolute -right-10 -top-10 h-36 w-36 rounded-full bg-pink-500/10 blur-3xl group-hover:bg-pink-500/30" />

                <Camera className="h-12 w-12 text-pink-400 transition duration-500 group-hover:scale-110 group-hover:rotate-12" />

                <h3 className="mt-6 text-xl font-semibold">Instagram</h3>

                <p className="mt-2 text-slate-400">Latest Aquarium Designs</p>
              ...
              >
                <div className="absolute -right-10 -top-10 h-36 w-36 rounded-full bg-blue-500/10 blur-3xl group-hover:bg-blue-500/30" />

                <Users className="h-12 w-12 text-blue-400 transition duration-500 group-hover:scale-110 group-hover:rotate-12" />

                <h3 className="mt-6 text-xl font-semibold">Facebook</h3>

                <p className="mt-2 text-slate-400">Join Our Community</p>
              ...
              >
                ...
                <p className="mt-2 text-slate-400">Quick Support</p>
              ...
              >
                <div className="absolute -right-10 -top-10 h-36 w-36 rounded-full bg-red-500/10 blur-3xl group-hover:bg-red-500/30" />

                <Play className="h-12 w-12 text-red-400 transition duration-500 group-hover:scale-110 group-hover:rotate-12" />

                <h3 className="mt-6 text-xl font-semibold">YouTube</h3>

                <p className="mt-2 text-slate-400">Latest Projects</p>
            ...
            <div className="space-y-5">
              {faqs.map((faq, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:border-cyan-400 hover:-translate-y-1"
                  >
                    <button
                      type="button"
        ...
        <section className="relative overflow-hidden py-20 md:py-24 lg:py-28">
          ...
          {/* Content */}
          <div className="container mx-auto max-w-7xl px-5 relative z-10">
            <div className="mx-auto max-w-4xl rounded-[36px] border border-cyan-500/20 bg-white/5 backdrop-blur-xl px-8 py-12 md:px-14 md:py-16 text-center">
              <span className="uppercase tracking-[0.35em] text-cyan-400 text-sm">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-slate-300 leading-8">
                Whether you&apos;re looking for a luxury home aquarium, a
                stunning aquascape, or a large commercial installation, our
                experts are ready to transform your vision into reality.
              </p>

              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="/consultation"
                  className="inline-flex items-center justify-center rounded-xl bg-cyan-500 px-8 py-4 font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-cyan-400"
                >
                  Book Consultation
                </Link>
                ...
                <Link
                  href="/gallery"
                  className="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/5 px-8 py-4 font-semibold text-white transition-all duration-300 hover:border-cyan-400 hover:bg-cyan-500/10"
                >
                  View Our Gallery
                </Link>
              </div>
