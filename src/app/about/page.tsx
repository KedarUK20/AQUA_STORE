...
const process = [
  ...
  },
  {
    ...
    title: "Stabilize",
    description:
      "We guide the early ecosystem cycle so the aquarium matures well.",
  },
  {
    step: "05",
    title: "Maintain",
    description:
      "Scheduled care keeps the aquarium healthy, clear and beautiful.",
  },
];
        ...
        <div className="container-custom relative z-10 grid min-h-[calc(100vh-6rem)] items-end gap-12 pb-8 pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pb-14 lg:pt-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-slate-200 sm:text-lg">
              We design, install and care for luxury aquatic environments that
              suit the space, support healthy ecosystems and stay beautiful long
              after launch day.
            </p>
        ...
        <div className="container-custom grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="lg:pl-6">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-slate-300">
              ...
              <p>
                Each project is planned around the room, the people using it and
                the living ecosystem inside the glass. The result is not just
                decoration; it is a calm focal point that can mature beautifully
                over time.
              </p>
            </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
            <div className="lg:sticky lg:top-32">
              ...
              <p className="mt-5 text-base leading-8 text-slate-400">
                ...
                installation and aftercare process simple, transparent and easy
                to follow.
              </p>
            </div>
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="max-w-2xl px-6 sm:px-10">
                ...
                <h2 className="mt-5 font-serif text-3xl leading-tight sm:text-4xl md:text-5xl">
                  Ready to build an aquarium that feels considered from day one?
                </h2>
                <p className="mt-4 text-base leading-8 text-slate-300">
                  Share your space, style and timeline. We will help you shape
                  the right aquarium concept and care plan.
                </p>
