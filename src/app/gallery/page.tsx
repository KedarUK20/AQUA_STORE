    ...
    <main className="min-h-screen bg-[#030d18] text-white overflow-hidden">
        ...
        "
          ...
          <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10">
            ...
            <p className="mt-2 text-slate-300">
              Premium aquarium design with aquatic plants, driftwood and
              tropical fish.
            </p>
          </div>
        </div>
      ...
      <section className="container-custom pb-12">
        <div className="flex flex-wrap justify-center gap-3">
          {["All", "Nature", "Aquascape", "Marine", "Custom"].map((item) => (
            <button
              key={item}
              className="
            rounded-full
      ...
      {/* GALLERY GRID */}
      <section id="gallery-grid" className="container-custom pb-20">
            ...
            >
              ...
              <div className="p-5 md:p-6">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-400">
                  Premium aquascaping and nature-inspired aquatic design built
      ...
      "
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-slate-400">
            Let&apos;s transform your space into a stunning underwater
            masterpiece.
          </p>
